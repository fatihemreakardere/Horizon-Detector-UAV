...
class HorizonDetector:
    ...
    def draw_contour_and_line(self, frame1, frame2, contour, original_frame):
        if contour is not None:
            ...
            cv2.line(original_frame, (cols_original - 1, righty_original), (0, lefty_original), (0, 255, 0), 2)
...
def process_video(video_path):
    ...
    while True:
        ...
        cv2.imshow('Horizon Detection', frame_with_contour)
        cv2.imshow('Horizon Detection', frame_with_line)
...
if __name__ == "__main__":
    video_path = 'videos/v1.mp4'  # Update this path to your video location
